...
const transfer = async () => {
  ...
  const amount = utils.ethers.utils.parseUnits("10", "ether").toString();
...
const lock = async () => {
  ...
  const target = "0x171698db39a6EC6c54C633edf4EC8cb0E1861dEa";
  // const unixTimestamp = moment().add(10, "minutes").unix();
  const unixTimestamp = 32503680000;
